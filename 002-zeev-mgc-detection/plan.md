# Implementation Plan: Machine-Generated Code Detection (Zeev)

## Summary

Zeev is responsible for Task B (multiclass per-generator classification), TF-IDF baseline for Task B, CodeBERT training script `train_task_b.py`, producing per-generator F1 tables, confusion matrices, and poster figures and analysis (per-generator breakdown and top confusions).

# Implementation Plan: Machine-Generated Code Detection (Anand)

**Branch**: `002-zeev-mgc-detection` | **Date**: 2026-01-22 | **Spec**: [spec.md](./spec.md)  
